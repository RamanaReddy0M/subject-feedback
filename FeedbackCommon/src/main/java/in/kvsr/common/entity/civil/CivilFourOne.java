...
@Entity
@Table(name="civil_4_1",uniqueConstraints = {
		@UniqueConstraint(columnNames = {"subject_code", "subject_name"})
})
public class CivilFourOne implements Subject{
	...
	public CivilFourOne(String subjectCode, String subjectName, String facultyRegId, Float average) {
	...
	public String toString() {
		return "CivilFourOne [subjectCode=" + subjectCode + ", subjectName=" + subjectName + ", facultyRegId="
