...
@Entity
@Table(name = "h_and_s_feedback",uniqueConstraints = {
	    @UniqueConstraint(columnNames = {"student_id", "subject_code"})
	})
public class HandSFeedback implements Feedback{
	...
	public HandSFeedback() {
		
	}

	public HandSFeedback(Long studentId, String subjectCode, String facultyRegId, Integer question1, Integer question2,
			Integer question3, Integer question4, Integer question5, String remarks) {
	...
	public String toString() {
		return "HandSFeedback [" + ", studentId=" + studentId + ", subjectCode=" + subjectCode
				+ ", facultyRegId=" + facultyRegId + ", question1=" + question1 + ", question2=" + question2
				+ ", question3=" + question3 + ", question4=" + question4 + ", question5=" + question5 + ", remarks="
				+ remarks + ", average=" + average + "]";
	}
