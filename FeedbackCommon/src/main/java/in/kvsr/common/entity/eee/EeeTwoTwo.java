...
@Entity
@Table(name="eee_2_2",uniqueConstraints = {
		@UniqueConstraint(columnNames = {"subject_code", "subject_name"})
})
public class EeeTwoTwo implements Subject{
	...
	public EeeTwoTwo(String subjectCode, String subjectName, String facultyRegId, Float average) {
	...
	public String toString() {
		return "EeeTwoTwo [subjectCode=" + subjectCode + ", subjectName=" + subjectName + ", facultyRegId="
