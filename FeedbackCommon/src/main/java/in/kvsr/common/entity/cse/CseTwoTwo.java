...
@Entity
@Table(name="cse_2_2",uniqueConstraints = {
		@UniqueConstraint(columnNames = {"subject_code", "subject_name"})
})
public class CseTwoTwo implements Subject{
	@Id
	...
	public CseTwoTwo(String subjectCode, String subjectName, String facultyRegId, Float average) {
	...
	public String toString() {
		return "CseTwoTwo [subjectCode=" + subjectCode + ", subjectName=" + subjectName + ", facultyRegId="
