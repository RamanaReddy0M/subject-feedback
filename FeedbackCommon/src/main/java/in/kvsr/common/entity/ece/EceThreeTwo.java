...
@Entity
@Table(name="ece_3_2",uniqueConstraints = {
		@UniqueConstraint(columnNames = {"subject_code", "subject_name"})
})
public class EceThreeTwo implements Subject{
	@Id
	...
	public EceThreeTwo(String subjectCode, String subjectName, String facultyRegId, Float average) {
	...
	public String toString() {
		return "EceThreeTwo [subjectCode=" + subjectCode + ", subjectName=" + subjectName + ", facultyRegId="
