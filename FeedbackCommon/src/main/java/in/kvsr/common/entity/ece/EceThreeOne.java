...
@Entity
@Table(name="ece_3_1",uniqueConstraints = {
		@UniqueConstraint(columnNames = {"subject_code", "subject_name"})
})
public class EceThreeOne implements Subject{
	...
	public EceThreeOne(String subjectCode, String subjectName, String facultyRegId, Float average) {
	...
	public String toString() {
		return "EceThreeOne [subjectCode=" + subjectCode + ", subjectName=" + subjectName + ", facultyRegId="
