...
@Entity
@Table(name="eee_1_2",uniqueConstraints = {
		@UniqueConstraint(columnNames = {"subject_code", "subject_name"})
})
public class EeeOneTwo implements Subject{
	@Id
	...
	public EeeOneTwo(String subjectCode, String subjectName, String facultyRegId, Float average) {
	...
	public String toString() {
		return "EeeOneTwo [subjectCode=" + subjectCode + ", subjectName=" + subjectName + ", facultyRegId="
