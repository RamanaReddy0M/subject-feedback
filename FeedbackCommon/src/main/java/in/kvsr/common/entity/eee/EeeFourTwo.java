...
@Entity
@Table(name="eee_4_2",uniqueConstraints = {
		@UniqueConstraint(columnNames = {"subject_code", "subject_name"})
})
public class EeeFourTwo implements Subject{
	@Id
	...
	public EeeFourTwo(String subjectCode, String subjectName, String facultyRegId, Float average) {
	...
	public String toString() {
		return "EeeFourTwo [subjectCode=" + subjectCode + ", subjectName=" + subjectName + ", facultyRegId="
