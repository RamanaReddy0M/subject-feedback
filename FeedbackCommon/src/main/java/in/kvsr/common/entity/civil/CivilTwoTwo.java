...
@Entity
@Table(name="civil_2_2",uniqueConstraints = {
		@UniqueConstraint(columnNames = {"subject_code", "subject_name"})
})
public class CivilTwoTwo implements Subject{
	@Id
	...
	public CivilTwoTwo(String subjectCode, String subjectName, String facultyRegId, Float average) {
	...
	public String toString() {
		return "CivilTwoTwo [subjectCode=" + subjectCode + ", subjectName=" + subjectName + ", facultyRegId="
