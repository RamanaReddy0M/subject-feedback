...
@Entity
@Table(name = "eee_feedback",uniqueConstraints = {
	    @UniqueConstraint(columnNames = {"student_id", "subject_code"})
	})
public class EeeFeedback implements Feedback{
	...
	public EeeFeedback(Long studentId, String subjectCode, String facultyRegId,Integer question1, Integer question2, Integer question3,
	...
	public String toString() {
		return "EeeFeedback [studentId=" + studentId + ", subjecCode=" + subjectCode +", F.regId:"+facultyRegId+ ", question1=" + question1
