...
@Entity
@Table(name="cse_2_1",uniqueConstraints = {
		@UniqueConstraint(columnNames = {"subject_code", "subject_name"})
})
public class CseTwoOne implements Subject{
	...
	public CseTwoOne(String subjectCode, String subjectName, String facultyRegId, Float average) {
	...
	public String toString() {
		return "CseTwoOne [subjectCode=" + subjectCode + ", subjectName=" + subjectName + ", facultyRegId="
