...
@Entity
@Table(name = "ece_feedback",uniqueConstraints = {
	    @UniqueConstraint(columnNames = {"student_id", "subject_code"})
	})
public class EceFeedback implements Feedback{
	...
	public EceFeedback(Long studentId, String subjectCode, String facultyRegId,Integer question1, Integer question2, Integer question3,
	...
	public String toString() {
		return "EceFeedback [studentId=" + studentId + ", subjecCode=" + subjectCode +", F.regId:"+facultyRegId+ ", question1=" + question1
