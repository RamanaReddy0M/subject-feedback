...
@Entity
@Table(name = "civil_feedback",uniqueConstraints = {
	    @UniqueConstraint(columnNames = {"student_id", "subject_code"})
	})
public class CivilFeedback implements Feedback{
	...
	public CivilFeedback() {
		
	}
	
	public CivilFeedback(Long studentId, String subjectCode, String facultyRegId,Integer question1, Integer question2, Integer question3,
	...
	public String toString() {
		return "CivilFeedback [studentId=" + studentId + ", subjecCode=" + subjectCode +", F.regId:"+facultyRegId+ ", question1=" + question1
