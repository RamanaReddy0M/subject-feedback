...
@Entity
@Table(name="cse_4_1",uniqueConstraints = {
		@UniqueConstraint(columnNames = {"subject_code", "subject_name"})
})
public class CseFourOne implements Subject{
	...
	public CseFourOne(String subjectCode, String subjectName, String facultyRegId, Float average) {
	...
	public String toString() {
		return "CseFourOne [subjectCode=" + subjectCode + ", subjectName=" + subjectName + ", facultyRegId="
