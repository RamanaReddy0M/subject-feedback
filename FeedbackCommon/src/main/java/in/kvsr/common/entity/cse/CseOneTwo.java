...
@Entity
@Table(name="cse_1_2",uniqueConstraints = {
		@UniqueConstraint(columnNames = {"subject_code", "subject_name"})
})
public class CseOneTwo implements Subject{
	@Id
	...
	public CseOneTwo(String subjectCode, String subjectName, String facultyRegId, Float average) {
	...
	public String toString() {
		return "CseOneTwo [subjectCode=" + subjectCode + ", subjectName=" + subjectName + ", facultyRegId="
