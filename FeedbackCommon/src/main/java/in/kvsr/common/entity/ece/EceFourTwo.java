...
@Entity
@Table(name="ece_4_2",uniqueConstraints = {
		@UniqueConstraint(columnNames = {"subject_code", "subject_name"})
})
public class EceFourTwo implements Subject{
	@Id
	...
	public EceFourTwo(String subjectCode, String subjectName, String facultyRegId, Float average) {
	...
	public String toString() {
		return "EceFourTwo [subjectCode=" + subjectCode + ", subjectName=" + subjectName + ", facultyRegId="
