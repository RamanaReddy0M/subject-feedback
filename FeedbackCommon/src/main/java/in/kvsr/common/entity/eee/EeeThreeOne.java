...
@Entity
@Table(name="eee_3_1",uniqueConstraints = {
		@UniqueConstraint(columnNames = {"subject_code", "subject_name"})
})
public class EeeThreeOne implements Subject{
	...
	public EeeThreeOne(String subjectCode, String subjectName, String facultyRegId, Float average) {
	...
	public String toString() {
		return "EeeThreeOne [subjectCode=" + subjectCode + ", subjectName=" + subjectName + ", facultyRegId="
