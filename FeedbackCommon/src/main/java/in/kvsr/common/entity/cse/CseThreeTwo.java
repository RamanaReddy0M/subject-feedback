...
@Entity
@Table(name="cse_3_2",uniqueConstraints = {
		@UniqueConstraint(columnNames = {"subject_code", "subject_name"})
})
public class CseThreeTwo implements Subject{
	@Id
	...
	public CseThreeTwo(String subjectCode, String subjectName, String facultyRegId, Float average) {
	...
	public String toString() {
		return "CseThreeTwo [subjectCode=" + subjectCode + ", subjectName=" + subjectName + ", facultyRegId="
