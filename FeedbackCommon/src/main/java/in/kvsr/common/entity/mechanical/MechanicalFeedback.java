...
@Entity
@Table(name = "mechanical_feedback",uniqueConstraints = {
	    @UniqueConstraint(columnNames = {"student_id", "subject_code"})
	})
public class MechanicalFeedback implements Feedback{
	...
	public MechanicalFeedback() {
		
	}
	
	public MechanicalFeedback(Long studentId, String subjectCode, String facultyRegId,Integer question1, Integer question2, Integer question3,
	...
	public String toString() {
		return "MechanicalFeedback [studentId=" + studentId + ", subjecCode=" + subjectCode +", F.regId:"+facultyRegId+ ", question1=" + question1
