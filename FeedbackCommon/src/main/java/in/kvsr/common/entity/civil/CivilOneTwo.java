...
@Entity
@Table(name="civil_1_2",uniqueConstraints = {
		@UniqueConstraint(columnNames = {"subject_code", "subject_name"})
})
public class CivilOneTwo implements Subject{
	@Id
	...
	public CivilOneTwo(String subjectCode, String subjectName, String facultyRegId, Float average) {
	...
	public String toString() {
		return "CivilOneTwo [subjectCode=" + subjectCode + ", subjectName=" + subjectName + ", facultyRegId="
