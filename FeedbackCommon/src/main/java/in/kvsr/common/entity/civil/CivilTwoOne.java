...
@Entity
@Table(name="civil_2_1",uniqueConstraints = {
		@UniqueConstraint(columnNames = {"subject_code", "subject_name"})
})
public class CivilTwoOne implements Subject{
	...
	public CivilTwoOne(String subjectCode, String subjectName, String facultyRegId, Float average) {
	...
	public String toString() {
		return "CivilTwoOne [subjectCode=" + subjectCode + ", subjectName=" + subjectName + ", facultyRegId="
