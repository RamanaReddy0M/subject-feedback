...
@Entity
@Table(name="ece_4_1",uniqueConstraints = {
		@UniqueConstraint(columnNames = {"subject_code", "subject_name"})
})
public class EceFourOne implements Subject{
	...
	public EceFourOne(String subjectCode, String subjectName, String facultyRegId, Float average) {
	...
	public String toString() {
		return "EceFourOne [subjectCode=" + subjectCode + ", subjectName=" + subjectName + ", facultyRegId="
