...
@Entity
@Table(name="ece_1_2",uniqueConstraints = {
		@UniqueConstraint(columnNames = {"subject_code", "subject_name"})
})
public class EceOneTwo implements Subject{
	@Id
	...
	public EceOneTwo(String subjectCode, String subjectName, String facultyRegId, Float average) {
	...
	public String toString() {
		return "EceOneTwo [subjectCode=" + subjectCode + ", subjectName=" + subjectName + ", facultyRegId="
