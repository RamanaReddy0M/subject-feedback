...
@Entity
@Table(name="eee_3_2",uniqueConstraints = {
		@UniqueConstraint(columnNames = {"subject_code", "subject_name"})
})
public class EeeThreeTwo implements Subject{
	@Id
	...
	public EeeThreeTwo(String subjectCode, String subjectName, String facultyRegId, Float average) {
	...
	public String toString() {
		return "EeeThreeTwo [subjectCode=" + subjectCode + ", subjectName=" + subjectName + ", facultyRegId="
