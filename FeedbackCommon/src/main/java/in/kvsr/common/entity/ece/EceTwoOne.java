...
@Entity
@Table(name="ece_2_1",uniqueConstraints = {
		@UniqueConstraint(columnNames = {"subject_code", "subject_name"})
})
public class EceTwoOne implements Subject{
	...
	public EceTwoOne(String subjectCode, String subjectName, String facultyRegId, Float average) {
	...
	public String toString() {
		return "EceTwoOne [subjectCode=" + subjectCode + ", subjectName=" + subjectName + ", facultyRegId="
