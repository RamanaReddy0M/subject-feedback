...
@Entity
@Table(name="civil_4_2",uniqueConstraints = {
		@UniqueConstraint(columnNames = {"subject_code", "subject_name"})
})
public class CivilFourTwo implements Subject{
	@Id
	...
	public CivilFourTwo(String subjectCode, String subjectName, String facultyRegId, Float average) {
	...
	public String toString() {
		return "CivilFourTwo [subjectCode=" + subjectCode + ", subjectName=" + subjectName + ", facultyRegId="
