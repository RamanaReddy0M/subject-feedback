...
@Entity
@Table(name="eee_4_1",uniqueConstraints = {
		@UniqueConstraint(columnNames = {"subject_code", "subject_name"})
})
public class EeeFourOne implements Subject{
	...
	public EeeFourOne(String subjectCode, String subjectName, String facultyRegId, Float average) {
	...
	public String toString() {
		return "EeeFourOne [subjectCode=" + subjectCode + ", subjectName=" + subjectName + ", facultyRegId="
