...
@Entity
@Table(name="cse_3_1",uniqueConstraints = {
		@UniqueConstraint(columnNames = {"subject_code", "subject_name"})
})
public class CseThreeOne implements Subject{
	...
	public CseThreeOne(String subjectCode, String subjectName, String facultyRegId, Float average) {
	...
	public String toString() {
		return "CseThreeOne [subjectCode=" + subjectCode + ", subjectName=" + subjectName + ", facultyRegId="
