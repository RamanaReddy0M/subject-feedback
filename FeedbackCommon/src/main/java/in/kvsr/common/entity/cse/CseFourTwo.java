...
@Entity
@Table(name="cse_4_2",uniqueConstraints = {
		@UniqueConstraint(columnNames = {"subject_code", "subject_name"})
})
public class CseFourTwo implements Subject{
	@Id
	...
	public CseFourTwo(String subjectCode, String subjectName, String facultyRegId, Float average) {
	...
	public String toString() {
		return "CseFourTwo [subjectCode=" + subjectCode + ", subjectName=" + subjectName + ", facultyRegId="
