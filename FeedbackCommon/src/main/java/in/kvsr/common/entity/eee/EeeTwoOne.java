...
@Entity
@Table(name="eee_2_1",uniqueConstraints = {
		@UniqueConstraint(columnNames = {"subject_code", "subject_name"})
})
public class EeeTwoOne implements Subject{
	...
	public EeeTwoOne(String subjectCode, String subjectName, String facultyRegId, Float average) {
	...
	public String toString() {
		return "EeeTwoOne [subjectCode=" + subjectCode + ", subjectName=" + subjectName + ", facultyRegId="
